<div class="p-4 pb-8">
    <h1 class="text-2xl font-medium border-b-2 border-indigo-500 p-2"><a class="text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-gray-100 overflow-hidden" href="/posts/{{$post->id}}" wire:navigate>{{$post->title}}</a></h1>
